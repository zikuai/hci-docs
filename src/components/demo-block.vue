...
<script>
    export default {
        ...
        computed: {
            ...
            controlText () {
                return this.isExpanded ? this.demoText['hide-text'] : this.demoText['show-text']
            },
...
<style>
    ...
    .demo-block .demo-block-control span.text-slide-enter,
    .demo-block .demo-block-control span.text-slide-leave-active {
        opacity: 0;
